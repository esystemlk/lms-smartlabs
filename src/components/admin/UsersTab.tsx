...
export function UsersTab({ users, onUserUpdated }: UsersTabProps) {
  ...
  const getRoleBadgeColor = (role: string) => {
    switch (role) {
      ...
      case "lecturer": return "bg-blue-600 text-white";
      case "developer": return "bg-emerald-500 text-white";
    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="flex gap-2 w-full md:w-auto">
            ...
            <div className="relative flex-1 md:w-64">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2 text-sm rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue transition-all"
              />
            </div>
            ...
            <div className="relative shrink-0">
              ...
              <select
                ...
                className="h-full pl-9 pr-8 py-2 text-sm rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue transition-all appearance-none bg-white cursor-pointer"
              >
      ...
      <div className="w-full overflow-x-auto">
        <div className="min-w-[800px] md:min-w-full">
          {/* Wrapper div to force min-width so the table doesn't squash on mobile */}
