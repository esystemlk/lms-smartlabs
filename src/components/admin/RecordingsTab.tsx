            ...
            <div className="flex space-x-2 border-b border-gray-200 dark:border-gray-800 overflow-x-auto pb-1">
                {[
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-t-lg transition-colors whitespace-nowrap ${activeTab === tab.id
                        ...
                        <div className="flex items-center gap-4 flex-1">
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-4 mt-1 text-xs font-medium">
                                    ...
                                    <span className="text-gray-400">{req.submittedAt?.seconds ? new Date(req.submittedAt.seconds * 1000).toLocaleString() : '-'}</span>
                                </div>
                            </div>
                        </div>
