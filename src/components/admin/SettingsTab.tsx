    ...
    <div className="space-y-8 animate-in fade-in max-w-4xl">
      <form onSubmit={handleSave} className="space-y-8">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
          ...
          <div className="bg-orange-50 dark:bg-orange-900/20 text-orange-800 dark:text-orange-300 p-4 rounded-xl text-sm mb-6 border border-orange-100 dark:border-orange-800 flex gap-3">
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-gray-700">
            ...
            {cleanupResult && (
              <div className="mt-2 text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 p-2 rounded">
        ...
        <section className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 shadow-sm">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-xl border border-gray-100 dark:border-gray-700">
        ...
        <div className="flex justify-end pt-4">
          <Button
            type="submit"
            disabled={saving}
            className="bg-brand-blue hover:bg-blue-700 text-white min-w-[150px] rounded-xl"
          >
            {saving ? (
              <>
