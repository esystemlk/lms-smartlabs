                  ...
                  <td className="px-4 py-3 md:px-6 md:py-4">
                    <div className="flex flex-col gap-2 items-start">
                      <button
                        ...
                        className={`inline-flex items-center gap-1 md:gap-1.5 px-2 py-0.5 md:px-2.5 md:py-0.5 rounded-full text-[10px] md:text-xs font-medium transition-colors ${course.published
                      ...
                      <button
                        ...
                        disabled={processingId === course.id}
                        className={`inline-flex items-center gap-1 md:gap-1.5 px-2 py-0.5 md:px-2.5 md:py-0.5 rounded-full text-[10px] md:text-xs font-medium transition-colors ${course.enrollmentStatus === 'closed'
