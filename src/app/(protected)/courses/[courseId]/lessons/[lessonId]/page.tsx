          ...
          <div className={clsx(
            ...
            {currentLesson.type === 'live_class' ? (
              ...
              !currentLesson.videoUrl.includes('http') && bunnyLibraryId ? (
                <iframe
                  src={`https://player.mediadelivery.net/embed/${bunnyLibraryId}/${currentLesson.videoUrl}?autoplay=false&loop=false&muted=false&preload=true&playsinline=true&disableIosPlayer=false`}
